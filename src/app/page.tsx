...
export default function HomePage() {
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100">
      ...
      <Link href="/regis/intern">Entre aqui para concluir perfil de Tutor!</Link>
      <Link href="/regis/intern">Entre aqui para concluir perfil de Orientador!</Link>
      <Link href="/regis/intern">Entre aqui para concluir perfil de Entidade de acolhimento!</Link>
    </div>
  );
}
